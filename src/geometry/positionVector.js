...
export class PositionVector {
    ...
    static createFromPointAndAngle(p1, angle, length=1) {
        const pv = Object.create(PositionVector.prototype);
        pv.position = new Point(p1.x, p1.y);
        pv.vector = Vector2d.createFromAngle(angle, length) ;
        return pv;
    }
